...
class ClientGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Client entity")
        ...
        .repeat(2) {
            ...
            .post("/api/clients")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "contactPerson":"SAMPLE_TEXT", "address":"SAMPLE_TEXT", "city":"SAMPLE_TEXT", "state":"SAMPLE_TEXT", "zipcode":null, "pf":null, "esic":null, "vda":null, "workHours":"0"}""")).asJSON
            .check(status.is(201))
