(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('facilitymgmtApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-facilitymgmtApp-error');
                var entityKey = httpResponse.headers('X-facilitymgmtApp-params');
                if (errorHeader) {
